...
public class Sprite {
    ...
    public static Image movingImage(Sprite normal, Sprite x1, Sprite x2, int animate, int time) {
        int calc = animate % time;
        int diff = time / 3;

        if (calc < diff) {
            return normal.getFxImage();
        }

        if (calc < diff * 2) {
            return x1.getFxImage();
        }

        return x2.getFxImage();
    }
    ...
    public static Image movingImage(Sprite x1, Sprite x2, int animate, int time) {
        int diff = time / 2;
        return (animate % time > diff) ? x1.getFxImage() : x2.getFxImage();
    }
